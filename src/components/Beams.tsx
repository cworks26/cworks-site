...
/* Beams — React Bits (reactbits.dev), TS-adapted for CWorks.
   Animated three.js light beams used as a section background.
   Reduced-motion: renders nothing (section keeps its normal background). */
...
function extendMaterial(BaseMaterial: any, cfg: any): THREE.ShaderMaterial {
  ...
  if ("envMapIntensity" in defaults) uniforms.envMap.value = defaults.envMapIntensity;
...
type MergedPlanesProps = { material: THREE.Material; width: number; count: number; height: number };
